...
if submitted:
    ...
    st.success(f'💳 Recommended Credit Limit Range: {credit_limit_range[0]:.2f} INR to  {credit_limit_range[1]:.2f} INR')
    # print(pred.item())
...
with st.sidebar:
    ...
    st.write("**Name:** Sahil Kavitake")
    st.write("**Email:** sahil.kavitake202@gmail.com")
    st.write("**LinkedIn:** [Let's Connect](https://www.linkedin.com/in/sahil-kavitake/)")
...
st.markdown(
    ...
    <div style="text-align: center;">
        ...
        <h5>Made with ❤️ by <a href="https://www.linkedin.com/in/sahil-kavitake/" target="_blank">Sahil Kavitake</a></h5>
    </div>
